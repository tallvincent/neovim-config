...
-- Don't allow lines to wrap around
vim.opt.wrap = false
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    branch = '0.1.x',
    dependencies = {
      -- https://github.com/BurntSushi/ripgrep needs to be installed
  ...
  { -- LSP Configuration & Plugins
    ...
    dependencies = {
      ...
      -- `neodev` conselect = truefigures Lua LSP for your Neovim config, runtime and plugins
